...
{
      system("cls");
      cout << endl << "\t-------CIFRATURA------" << endl << endl;
      cout << "\tPercorso realizzato da Mauro Marzocca" << endl;
      cout << "\tVersione 1.4" << endl;
      cout << endl;
      cout << "\t1)  Cesare" << endl;
      cout << "\t2)  ROT13" << endl;
      cout << "\t3)  Cifratura MonoAlfabetica" <<endl << endl;
      cout << "\t4)  Modifiche versioni Precedenti" << endl;
      cout << "\t0)  Fine";
      cout << endl << endl << "\tOpzione: ";
      cin >> scelta;
      cout << endl;
      switch(scelta)
      {
              ...
              case 0: cout << endl <<"\tGrazie di aver usato il mio Programma!" << endl << endl;
                        cout << "\t";
                      system("pause");
                      return 0;
                      break;
